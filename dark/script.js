...
const darkScreen = document.getElementById("dark-screen"); // Referência à tela escura
...
function saveGameProgress() {
  ...
  // O quizData em si é estático, então não precisa ser salvo a cada progresso.
  // Se o quizData pudesse ser alterado dinamicamente, ele também seria salvo aqui.
}
...
function checkAnswer() {
  ...
  if (selectedOption === qData.correct) {
    ...
    saveGameProgress(); // Salva o progresso após uma resposta correta
  } else {
...
function checkCorrectAnswer() {
  ...
  checkCorrect();
  saveGameProgress(); // Salva o progresso após marcar a resposta correta
...
// Função para carregar o jogo (dados do quiz e progresso)
function loadGameData() {
  ...
  initializeGame(); // Inicializa o jogo após carregar os dados
}

// Função para inicializar o jogo após o carregamento dos dados
